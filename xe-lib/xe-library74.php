...
function sendmail_int($to,$subject,$message){
...
// More headers
$headers .= 'From: <support@errandpilot.com>' . "\r\n";
...
function x_send_json($postData, $url, $token) {
	...
	include_once("telegramApi.php"); // Telegram Api
	include_once("fileHandling_Functions.php"); // File uploader functions
	//include_once("payment_functions.php");// Paystack payment functions
	include_once("domingos_sp_functions.php");// functions from domingos social
	//include_once("iuofunction.php"); // Include the iuosite functions
	include_once("mobilefunction.php"); // Mobile Functions
	include_once("errandpilot_functions.php"); //Errand Pilot functions
	//include_once("testingfunctions.php"); // not stable yet but working
	include_once("carriagepalsFunctions.php"); // Carriagepals functions
	//include_once("schms_functions.php"); // School management system functions
	include_once("billpaymentFunctions.php"); // Bills payment
	//include_once("flutterwaveApi.php"); // Flutterwave Api
	//include_once("new_db_functions.php"); // db functions
	//include_once("blochqAPI.php"); // Blochq.io API
	//include_once("ApironeApi.php"); // apirone.com API
	include_once("hotelFunctions.php"); // Hotel API
